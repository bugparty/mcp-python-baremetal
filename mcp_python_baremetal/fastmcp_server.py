# mcp_python_baremetal/fastmcp_server.py
...
mcp = FastMCP(name="Python Baremetal Executor")
...
async def analyze_imports(code: str) -> Dict[str, Any]:
    """Analyze Python code to identify missing imports and show what would be auto-imported.
